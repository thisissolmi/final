...
class _DetailpageState extends State<Detailpage> {
  String defaulturi ='https://upload.wikimedia.org/wikipedia/en/c/c8/HGUseal.png';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          TextButton(child: Text('수정'),
          onPressed: () => Navigator.push(context, 
            MaterialPageRoute(builder: (context)=> UpDatepage(product: widget.product)
              ) ,
             ),
            ),
        ],
