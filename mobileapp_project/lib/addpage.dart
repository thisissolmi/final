...
const List<String> dorplist = ['한식','중식','양식'];
...
class _ProductAddPageState extends State<ProductAddPage> {
  ...
  Widget _buildCategoryButton(String value, List<String> categoryname, Function(String?) onchanged) {
            ...
            children: [
               ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: selectedTakeout == "매장" ? Colors.blue : Colors.grey,
                ),
                child: Text("매장"),
              ),
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: selectedTakeout == "포장" ? Colors.blue : Colors.grey,
                ),
                child: Text("포장"),
              ),
            ],
